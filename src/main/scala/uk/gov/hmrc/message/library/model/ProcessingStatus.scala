...
case object Delivered extends ResultStatus

object ProcessingStatus {
  val processingStatuses: Set[ProcessingStatus] =
    Set(ToDo, InProgress, Succeeded, Failed, PermanentlyFailed, Ignored, Duplicate, Deferred, Cancelled, Delivered)
  ...
  implicit val variantBsonWriter: VariantBSONWriter[ProcessingStatus, BSONString] =
